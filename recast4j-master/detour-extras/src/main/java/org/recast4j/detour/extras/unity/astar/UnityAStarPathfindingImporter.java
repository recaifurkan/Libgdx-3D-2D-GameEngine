...
public class UnityAStarPathfindingImporter {
    ...
    public static void saveMesh(NavMesh mesh, File file) throws IOException {
        ...
        writer.write(os, mesh, ByteOrder.LITTLE_ENDIAN, false);
        os.close();
    }

    public static void main(String[] args) throws Exception {
        MeshSetReader reader = new MeshSetReader();
        FileInputStream stream = new FileInputStream(new File("nav.nav"));
        NavMesh read = reader.read(stream);
