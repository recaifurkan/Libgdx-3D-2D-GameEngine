...
import com.rfbsoft.game.engine.systems.g2d.ClientG2dGameSystems;
import com.rfbsoft.game.engine.systems.g2d.G2dGameSystems;
import com.rfbsoft.game.engine.systems.g3d.ClientG3dGameSystems;
...
public class ClientGameInitializer implements Disposable {
    ...
    public ClientGameInitializer() {
        if (GameFields.systemType == GameFields.GameType.G2D) {
            gameSystem = new ClientG2dGameSystems();
            new G2dEntites();
        } else {
            gameSystem = new ClientG3dGameSystems();
            new G3dEntites();
        }
